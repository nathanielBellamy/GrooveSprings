...
export class PlaylistsEffects {
  ...
  fetchPlaylists$ = createEffect(() =>
    this.actions$.pipe(
      ofType<FetchAll | SetArtistsFilter | SetAlbumsFilter | PlaylistCreateSuccess | PlaylistUpdateSuccess>(
