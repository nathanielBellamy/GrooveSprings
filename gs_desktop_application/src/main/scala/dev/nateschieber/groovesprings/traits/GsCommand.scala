...
final case class SetFilePath(path: String, replyTo: ActorRef[RespondSetFilePath]) extends GsCommand
final case class RespondSetFilePath(replyTo: ActorRef[SetFilePath]) extends GsCommand
